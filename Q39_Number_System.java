...
public class Q39_Number_System {

    static void HexaMenu() {
        System.out.println("*****************************");
        System.out.println("        Conversion from HEXA        ");
        System.out.println("ENTER '0' :- Menu ");
        System.out.println("ENTER '1' :- Exit ");
        System.out.println("ENTER '2' :- Convert Hexa to Decimal conversion ");
        System.out.println("ENTER '3' :- Convert Hexa to Octal conversion ");
        System.out.println("ENTER '4' :- Convert Hexa to Binary conversion ");
        System.out.println("*******************************");
    ...
    static void OctalMenu() {
        System.out.println("***************************************");
        System.out.println("        Conversion from OCTAL         ");
        System.out.println("ENTER '0' :- Menu ");
        System.out.println("ENTER '1' :- Exit ");
        System.out.println("ENTER '2' :- Convert Octal to Decimal conversion ");
        System.out.println("ENTER '3' :- Convert Octal to Hex conversion ");
        System.out.println("ENTER '4' :- Convert Octal to Binary conversion ");
        System.out.println("*****************************************");
    }

    static void BinaryMenu() {
        System.out.println("*******************************************");
        System.out.println("        Conversion from BINARY        ");
        System.out.println("ENTER '0' :- Menu ");
        System.out.println("ENTER '1' :- Exit ");
        System.out.println("ENTER '2' :- Convert Binary to Decimal conversion ");
        System.out.println("ENTER '3' :- Convert Binary to Hex conversion ");
        System.out.println("ENTER '4' :- Convert Binary to Octal conversion ");
        System.out.println("*********************************************");
    }

    static void DecimalMenu() {
        System.out.println("**********************************************");
        System.out.println("        Conversion from DECIMAL         ");
    ...
    static void Menu() {
        ...
        System.out.println("***************************************");
        System.out.println("Please choose the option from Above MENU");
    }
        ...
        while (true){
            ...
            switch (num){
                ...
                case 3:
                    ...
                    while(true) {
                        ...
                        if (nn == 0) {
                            ...
                            System.out.println("Enter number to Convert Decimal to Binary system");
                            String n = sc.next();
                            ...
                            try {
                                ...
                                System.out.println("Please enter correct Decimal Number.");
                            }

                        } else if (nn == 3) {
                            // Convert Decimal to Hex conversion
                            System.out.println("Enter number to Convert Decimal to Hex number");
                            String n = sc.next();
                            ...
                            System.out.println("Enter number to Convert Decimal to Octal number");
                            String n = sc.next();
                            ...
                            System.out.println("Sorry 'Try with correct' command. There is no command '" + nn);
                        }
                    }
                    break;
                case 4:
                    ...
                    while(true) {
                        ...
                        if (nn == 0) {
                            ...
                            // Convert Decimal to Hex conversion
                            System.out.println("Enter number to Convert Binary to Hex ");
                            String n = sc.next();
                            ...
                            // Convert Decimal to Octal conversion
                            System.out.println("Enter number to Convert Binary to Octal");
                            String n = sc.next();
                ...
                case 5:
                    ...
                    while(true) {
                        ...
                        if (nn == 0) {
                            ...
                            System.out.println("Enter number to Convert Octal to Hex ");
                            String n = sc.next();
                ...
                case 6:
                    ...
                    while(true) {
                        ...
                        if (nn == 0) {
                            ...
                            try {
                                ...
                                System.out.println("Please enter correct hexadecimal Numberb.");
                            }

                        } else if (nn == 3) {
                            // Convert Decimal to Hex conversion
                            System.out.println("Enter number to Convert Hexa to Octal ");
                            String n = sc.next();
                            ...
                            // Convert Decimal to Octal conversion
                            System.out.println("Enter number to Convert Hexa to Binary ");
                            String n = sc.next();
                    ...
                    break;
                default:
                    System.out.println("Sorry 'Try with correct' command. There is no command '" + num +  "'. \nPlease try '1' for MENU OR '2' for EXIT. ");
            }
        }
    }
}
